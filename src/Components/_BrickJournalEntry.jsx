    ...
    <div className="main">
      ...
      <div className="flex justify-center align-center" id="card">
        <div className="tag-container">
          <div
            onClick={handleCard1}
            className={`tag ${isRotated1 ? "rotated_one" : ""}`}
          >
            <div className="tag-side tag-1-side">
              <div className="tag-text tag-1-text">
                ...
                />
                <p>{prompt}</p>
                <div className="flex justify-end" id="rotate-icon">
                  <svg
                    width="50px"
                    style={{ margin: "10px" }}
                    height="50px"
            ...
            <div className="tag-side tag-1-side is-back">
              <div
                className="tag-text tag-1-text px-3 p-1"
                style={{ textAlign: "left" }}
              >
                <p id="entry-text" dangerouslySetInnerHTML={entryHtml}></p>
                <div className="flex justify-end" id="rotate-icon">
                  <svg
                    onClick={handleCard1}
                    width="50px"
        ...
        <div className="tag-container">
          <div
            onClick={handleCard2}
            className={`tag ${isRotated2 ? "rotated_two" : ""}`}
          >
            <div className="tag-side tag-1-side">
              <div className="tag-text tag-1-text">
                <img
            ...
            <div className="tag-side tag-1-side is-back">
              <div className="tag-text tag-1-text">
                <p
                  style={{ textAlign: "left" }}
                  id="entry-text"
                  dangerouslySetInnerHTML={advancedEntryHtml}
                ></p>
                <div className="flex justify-end" id="rotate-icon">
                  <svg
                    style={{ margin: "10px" }}
